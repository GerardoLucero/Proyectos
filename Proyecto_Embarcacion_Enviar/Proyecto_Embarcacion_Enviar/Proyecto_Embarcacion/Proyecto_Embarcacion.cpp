...
// Proyecto_Embarcacion.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CProyecto_EmbarcacionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CProyecto_EmbarcacionApp

CProyecto_EmbarcacionApp::CProyecto_EmbarcacionApp()
{
...
// El único objeto CProyecto_EmbarcacionApp

CProyecto_EmbarcacionApp theApp;


// Inicialización de CProyecto_EmbarcacionApp

BOOL CProyecto_EmbarcacionApp::InitInstance()
{
