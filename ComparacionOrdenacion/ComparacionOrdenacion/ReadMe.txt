========================================================================
    APLICACIÓN DE CONSOLA: ComparacionOrdenacion Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ComparacionOrdenacion.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ComparacionOrdenacion.


ComparacionOrdenacion.vcxproj
...
ComparacionOrdenacion.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ComparacionOrdenacion.pch y un archivo de tipos precompilados llamado StdAfx.obj.
